...
const CareerDetails = () => {
  ...
  return (
    <div className="sm:p-4 pt-16 sm:pt-20">
      <div className="px-2">
        <h2 className="text-xl font-semibold text-gray-800">
          Career Details for{" "}
          <span className="text-red-700">{career.title}</span>
        </h2>
        <p>
      ...
      <div className="p-2">
        ...
        <p className="pl-2 text-gray-700">
          {career.job_summary || "No summary available"}
        </p>
        <h3 className="font-bold font-serif text-lg mt-2">
        ...
        <ul className="pl-2 text-gray-700">
          {career.job_requirements.map((req, index) => (
            <li key={index}>{req}</li>
          ))}
        </ul>
      </div>
