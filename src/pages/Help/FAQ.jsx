    ...
    <div className="pt-8 md:mx-8">
      ...
      <div className="my-2 px-2 py-3 bg-gray-50 text-left shadow-sm shadow-gray-300 sm:shadow-none hover:shadow-md duration-300 rounded-sm">
        ...
        <p>
          ...
          eligendi delectus dolore suscipit perspiciatis doloremque nemo dolorem
          facere cum iusto, consequatur omnis facilis optio? Accusamus repellat
      ...
      <div className="my-2 px-2 py-3 bg-gray-50 text-left shadow-sm shadow-gray-300 sm:shadow-none hover:shadow-md duration-300 rounded-sm">
        ...
        <p>
          ...
          temporibus nulla et incidunt tempora a deleniti eos quibusdam sequi
          magnam!
        </p>
      </div>
      <div className="my-2 px-2 py-3 bg-gray-50 text-left shadow-sm shadow-gray-300 sm:shadow-none hover:shadow-md duration-300 rounded-sm">
        ...
        <p>
          ...
          quaerat eveniet beatae possimus minus aliquam reprehenderit saepe, rem
          natus voluptatem atque eligendi soluta quisquam?
        </p>
      </div>
    </div>
  );
